...
class Platform {
    ...
    cloneEmbeddable(data) {
        const copy = (0, clone_1.default)(data);
    ...
    shouldHaveColumn(prop, populate, includeFormulas = true) {
        ...
        return [enums_1.ReferenceType.SCALAR, enums_1.ReferenceType.MANY_TO_ONE, enums_1.ReferenceType.EMBEDDED].includes(prop.reference) || (prop.reference === enums_1.ReferenceType.ONE_TO_ONE && prop.owner);
    }
    /**
